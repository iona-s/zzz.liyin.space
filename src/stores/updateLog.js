...
export const useUpdateLogStore = defineStore('updateLog', () => {
    const updateLogInfo = [
        {
            version: '2.2.0', 
            date: '2025-09-04', 
            title: '新增2.2版本成就，新增2.2版本角色',
            changes: '<ul><li>新增2.2版本成就</li><li>新增2.2版本角色</li></ul>' 
        },
        {
            version: '2.1.5', 
            date: '2025-07-19', 
            title: '修正2.1版本多选一成就',
            changes: '<ul><li>修正2.1版本多选一成就</li></ul>' 
        },
        {
            version: '2.1.4', 
            date: '2025-07-17', 
            title: '修正2.1版本部分成就描述',
            changes: '<ul><li>修正2.1版本部分成就描述</li></ul>' 
        },
        {
            version: '2.1.3', 
            date: '2025-07-17', 
        ...
        { 
            ...
            date: '2025-07-17', 
            title: '补充2.1版本成就缺少描述',
            changes: '<ul style="padding-left: 10px;"><li>补充2.1版本成就缺少描述</li></ul>' 
        },
        { 
            version: '2.1.0', 
            date: '2025-07-16', 
            title: '新增2.1版本成就',
            changes: '<ul style="padding-left: 10px;"><li>新增2.1版本成就</li></ul>' 
        },
        { 
            version: '2.0.2', 
            date: '2025-06-09', 
            title: '修正部分成就描述',
            changes: '<ul style="padding-left: 10px;"><li>修正部分成就描述</li></ul>' 
        },
        { 
            version: '2.0.1', 
            date: '2025-06-07', 
        ...
        { 
            ...
            date: '2025-04-26', 
            title: '新增1.7版本上半角色',
            changes: '<ul style="padding-left: 10px;"><li>新增1.7版本上半角色</li></ul>' 
        },
        { 
            version: '1.7.0', 
            date: '2025-04-23', 
        ...
        { 
            ...
            changes: '<ul style="padding-left: 10px;"><li>修正“暂无迷失之虞”成就奖励类型错误问题</li></ul>' 
        },
        { 
            version: '1.6.1', 
            date: '2025-03-16', 
        ...
        { 
            ...
            changes: '<ul style="padding-left: 10px;"><li>新增1.6版本成就</li><li>新增1.5版本下半角色</li></ul>' 
        },
        { 
            version: '1.5.0', 
            date: '2025-01-21', 
        ...
        { 
            ...
            changes: '<ul style="padding-left: 10px;"><li>将“完美闪避”成就设置为暂不可获得成就</li><li>新增1.2版本角色</li><li>新增成就界面设置特殊文本内容功能，如自定义账号主角性别等</li><li>新增自定义暂不可获得成就功能，长按对应成就的选择按钮即可弹出设置自定义暂不可获得窗口</li><li>将设置界面中与成就相关的选项移动至成就界面的设置窗口中</li><li>修复导入成就功能存在的部分问题</li></ul>' 
        },
        { 
            version: '1.2.0', 
            date: '2024-09-26', 
            title: '新增1.2版本成就',
            changes: '<ul style="padding-left: 10px;"><li>新增1.2版本成就</li></ul>' 
        },
        { 
            version: '1.1.0', 
            date: '2024-08-14', 
    ...
    const LAST_SHOW_UPDATE_LOG_VERSION_KEY = 'zzz-last-show-update-log-version'
